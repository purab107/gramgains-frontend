  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={cn(
          'flex aspect-video justify-center text-xs [&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-grid_line]:stroke-border/50 [&_.recharts-sector]:outline-none [&_.recharts-surface]:outline-none',
          className
        )}
        {...props}
      >
...
// Minimal payload type compatible with Recharts internal shape
...
function getPayloadConfigFromPayload(
  ...
  if (key in p && typeof p[key] === 'string') {
    ...
    resolvedKey = inner[key] as string;
  }
