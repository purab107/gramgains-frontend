  ...
  return (
    <div className="bg-card text-card-foreground border border-border p-5 rounded-3xl shadow-sm hover:shadow-md transition-all flex items-center gap-4 h-full">
      ...
      <div className="min-w-0 flex-1">
        <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Night</span>
        <h3 className="text-base font-bold text-foreground truncate">Dinner</h3>
        <p className="text-lg font-extrabold text-indigo-500 mt-0.5 truncate">
